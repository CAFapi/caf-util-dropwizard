...
/**
 * A custom implementation of StringSubstitutor that provides additional functionality
 * for variable substitution, including secret lookup.
 * <p>
...
public final class CafConfigSubstitutor extends StringSubstitutor
{
     ...
     *               If true, an exception will be thrown for undefined variables.
    ...
    private static StringLookup createStringLookup()
    {
        ...
        final StringLookup secretLookup = key -> {
            try {
                ...
                throw new RuntimeException("Unable to read secret: " + key, e);
            }
        };
